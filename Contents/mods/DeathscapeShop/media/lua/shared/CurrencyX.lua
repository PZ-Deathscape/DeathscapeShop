...
Currency.BaseCoin = "Base.DeathCoin"
Currency.SpecialCoin = "Base.ServiceCoin"
...
Currency.CoinsTexture = {
	Coin = {
		texture = getTexture("media/textures/Item_DeathCoin.png"),
		scale = 15
	},
	SpecialCoin = {
		texture = getTexture("media/textures/Item_ServiceCoin.png"),
		scale = 15
	},
}